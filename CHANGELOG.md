...
- Added rollout flag `beads.sortPicker.enabled` (default on) to enable/disable the new sort picker and assignee grouping; picker shows in the toolbar and command palette only when enabled.
