...
/**
 * Read feedback-related settings. If the repository is invalid, the feature flag is treated as disabled
 * and a validationError message is provided for UI callers.
 */
